...
\begin{equation}\label{eq:pcm}
    ...
    \right.
\end{equation}
where $\delat_k$ is the location of the $k$-th step on the latent trait continuum and is referred to as the item step parameter associated with a grade category (also referred to as step difficulty or threshold). Model parameters in \cref{eq:pcm} can be solved using joint maximum likelihood estimation or the conditional maximum likelihood estimation.
