...
target_gpa <- data.table::fread("M:/p1708-tctan/Documents/gpa1.csv")
student_id <- target_gpa$w21_4952_lopenr_person
...
for (i in 1:length(student_id)) { # Go through the Student ID list:
