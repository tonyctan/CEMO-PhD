...
\vspace{0.5\baselineskip} %insert line for clearer spacing
\begin{figure}[h]
        \caption{Model Diagram}
        \label{fig:simple}
\begin{tikzpicture}[
    latvar/.style={ellipse,draw=black,minimum width=2cm,minimum height=2cm},
    manvar/.style={rectangle,draw=black,minimum width=2cm,minimum height=2cm},
    ->,>=stealth',semithick,bend angle=-45,decoration={zigzag,amplitude=1pt,segment length=1mm,post=lineto,post length=4pt}
    ]
% Draw variables
    \node[manvar] (X) at (1,1) {$X$};
    \node[latvar] (Y) at (8,1) {$Y$};
