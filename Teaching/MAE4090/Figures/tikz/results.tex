\MAEptikz{fig:results}{Two-level Structural Equation Model Predicting Youth's Financial Literacy Outcomes}{
\begin{tikzpicture}[
...
\end{tikzpicture}
}{ % I gave up. No idea why notes run off page. Just going to use \\
