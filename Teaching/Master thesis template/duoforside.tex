...
\newcommand{\duo@fac@eng}{Faculty of Educational Sciences}
\newcommand{\duo@fac@bm}{Det utdanningsvitenskapelige fakultet}
\newcommand{\duo@fac@nn}{Det utdanningsvitenskapelige fakultet}
...
%% Determine the term (as in "Spring 2021"):
